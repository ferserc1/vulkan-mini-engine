...
class SkySphereDelegate : public vkme::DrawLoopDelegate, public vkme::UserInterfaceDelegate {
public:
...
protected:
    ...
    std::unique_ptr<vkme::core::Buffer> _sceneDataBuffer;
    std::unique_ptr<vkme::core::DescriptorSet> _sceneDataDescriptorSet;
