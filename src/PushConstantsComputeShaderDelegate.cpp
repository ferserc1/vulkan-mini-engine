...
void PushConstantsComputeShaderDelegate::cleanup()
{
    _drawImage->cleanup();
}

void PushConstantsComputeShaderDelegate::swapchainResized(VkExtent2D newExtent)
{
...
VkImageLayout PushConstantsComputeShaderDelegate::draw(
    VkCommandBuffer cmd,
