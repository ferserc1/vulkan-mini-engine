...
void ClearBackgroundDrawDelegate::init(miniengine::VulkanData * vulkanData)
{
...
void ClearBackgroundDrawDelegate::draw(VkCommandBuffer cmd, VkImage swapchainImage, VkExtent2D imageExtent, uint32_t currentFrame)
{
...
void ClearBackgroundDrawDelegate::drawBackground(VkCommandBuffer cmd, uint32_t currentFrame)
{
    ...
    auto clearRange = miniengine::core::Image::subresourceRange(VK_IMAGE_ASPECT_COLOR_BIT);
