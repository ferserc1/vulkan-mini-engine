...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Modificación: en data2.x se envía un valor que varía entre 0 y 1 de forma senoidal
    // que depende del fotograma. Si modificamos StarFieldThresshold con este valor, podemos
    // implementar un parpadeo de estrellas
    StarFieldThreshhold -= PushConstants.data2.x / PushConstants.data2.y; 
